# Generated by Django 5.0.8 on 2025-09-05 18:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('local_slug', models.SlugField(default='temp-slug', max_length=100, verbose_name='شناسه محلی')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eli_uri_work', models.URLField(blank=True, help_text='https://domain/country/type/year/number<br>مثال: https://laws.example.ir/ir/act/2020/123', verbose_name='ELI URI اثر')),
                ('urn_lex', models.CharField(blank=True, help_text='ir:authority:doc_type:yyyy-mm-dd:number<br>مثال: ir:majlis:law:2020-06-01:123', max_length=200, verbose_name='URN LEX')),
                ('local_slug', models.SlugField(default='temp-slug', max_length=100, unique=True, verbose_name='شناسه محلی')),
                ('subject_summary', models.TextField(blank=True, verbose_name='خلاصه موضوع')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('started_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='started_ingests', to=settings.AUTH_USER_MODEL, verbose_name='آغازکننده')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(blank=True, editable=False)),
                ('bucket', models.CharField(default='advisor-docs', max_length=100, verbose_name='سطل')),
                ('object_key', models.CharField(blank=True, max_length=500, verbose_name='مسیر فایل')),
                ('original_filename', models.CharField(blank=True, max_length=255, verbose_name='نام فایل اصلی')),
                ('content_type', models.CharField(blank=True, max_length=100, verbose_name='نوع فایل')),
                ('size_bytes', models.PositiveBigIntegerField(default=0, verbose_name='حجم فایل (بایت)')),
                ('sha256', models.CharField(blank=True, max_length=64, verbose_name='اثر انگشت فایل')),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField(db_index=True)),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ...
                ('manifestation', models.ForeignKey(blank=True, db_constraint=False, help_text='مرجع به انتشار سند (FRBR Manifestation)', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='documents.instrumentmanifestation', verbose_name='انتشار سند')),
                ('legal_unit', models.ForeignKey(blank=True, db_constraint=False, help_text='مرجع به جزء سند حقوقی', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='documents.legalunit', verbose_name='جزء سند حقوقی')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manifestation', models.ForeignKey(blank=True, help_text='مرجع به انتشار سند (FRBR Manifestation)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='files', to='documents.instrumentmanifestation', verbose_name='انتشار سند')),
                ('legal_unit', models.ForeignKey(blank=True, help_text='مرجع به جزء سند حقوقی', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='files', to='documents.legalunit', verbose_name='جزء سند حقوقی')),
            ],
            options={
